...
function beginPage(res, title) {
    ...
    res.write("<link rel='stylesheet' href='//maxcdn.bootstrapcdn.com/bootstrap/3.3.2/css/bootstrap.min.css'>\n");
    res.write("</head>\n");
    res.write("<body>\n");
}
...
function endForm(res) {
    res.write("<input type='submit' class='btn btn-primary' value='Push'>\n");
    res.write("</form>\n");
}
